...
construct; screening or design with controls; and final report claims.
...
change the decision. Check the findings against the evidence, fix accepted
issues, rerun affected checks, and record any
unresolved limitations before continuing. Stay within the existing scope
